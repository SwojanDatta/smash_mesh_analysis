function varargout = ckt2(varargin)
% CKT2 MATLAB code for ckt2.fig
%      CKT2, by itself, creates a new CKT2 or raises the existing
%      singleton*.
%
%      H = CKT2 returns the handle to a new CKT2 or the handle to
%      the existing singleton*.
%
%      CKT2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CKT2.M with the given input arguments.
%
%      CKT2('Property','Value',...) creates a new CKT2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ckt2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ckt2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ckt2

% Last Modified by GUIDE v2.5 14-Sep-2019 23:17:04

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ckt2_OpeningFcn, ...
                   'gui_OutputFcn',  @ckt2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ckt2 is made visible.
function ckt2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ckt2 (see VARARGIN)

% Choose default command line output for ckt2
...
% UIWAIT makes ckt2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ckt2_OutputFcn(hObject, eventdata, handles) 
...
[y fs]=audioread('you-selected-number 2.wav');
sound(y,fs)
...
box1= [   r1+r2   -r2           0          0           ;...
           -r2    r2+r3+r4      -r4        0           ;...
            0     -r4           r4+r5+r6+r7   -r7         ;...
            0     0             -r7        r8+r7       ];
box2= [   v2-v1 ;  v3-v2-v4    ;  v4+v6-v5-v7    ;  v7-v8 ];


global box3_2

if i==0
    box3_2 = inv(box1)*box2
else
    if i1~=0
    ...
    if i7~=0
        [box1,box2] = supermesh(4,3,i7,box1,box2);
    end
