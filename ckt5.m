function varargout = ckt5(varargin)
% CKT5 MATLAB code for ckt5.fig
%      CKT5, by itself, creates a new CKT5 or raises the existing
%      singleton*.
%
%      H = CKT5 returns the handle to a new CKT5 or the handle to
%      the existing singleton*.
%
%      CKT5('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CKT5.M with the given input arguments.
%
%      CKT5('Property','Value',...) creates a new CKT5 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ckt5_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ckt5_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ckt5

% Last Modified by GUIDE v2.5 05-Sep-2019 05:15:34

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ckt5_OpeningFcn, ...
                   'gui_OutputFcn',  @ckt5_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ckt5 is made visible.
function ckt5_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ckt5 (see VARARGIN)

% Choose default command line output for ckt5
...
[y fs]=audioread('you selected number 5.wav');
sound(y,fs)


% UIWAIT makes ckt5 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ckt5_OutputFcn(hObject, eventdata, handles) 
...
box1= [   r1+r2   -r2           0          0              ;...
           -r2    r2+r3+r4      -r4        0              ;...
            0     -r4           r4+r5+r6+r7   -r7         ;...
            0     0             -r7        r8+r7          ];
box2= [   v2-v1 ;  v4-v2-v3    ;  v7+v6-v5-v4    ;  v8-v7 ];


global box3_5

if i==0
    box3_5 = inv(box1)*box2
else
    if i1~=0
