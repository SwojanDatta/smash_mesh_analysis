function varargout = ckt7_output(varargin)
% CKT7_OUTPUT MATLAB code for ckt7_output.fig
%      CKT7_OUTPUT, by itself, creates a new CKT7_OUTPUT or raises the existing
%      singleton*.
%
%      H = CKT7_OUTPUT returns the handle to a new CKT7_OUTPUT or the handle to
%      the existing singleton*.
%
%      CKT7_OUTPUT('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CKT7_OUTPUT.M with the given input arguments.
%
%      CKT7_OUTPUT('Property','Value',...) creates a new CKT7_OUTPUT or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ckt7_output_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ckt7_output_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ckt7_output

% Last Modified by GUIDE v2.5 15-Sep-2019 00:43:38

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ckt7_output_OpeningFcn, ...
                   'gui_OutputFcn',  @ckt7_output_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ckt7_output is made visible.
function ckt7_output_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ckt7_output (see VARARGIN)

% Choose default command line output for ckt7_output
...
% UIWAIT makes ckt7_output wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ckt7_output_OutputFcn(hObject, eventdata, handles) 
