function varargout = ckt7(varargin)
% CKT7 MATLAB code for ckt7.fig
%      CKT7, by itself, creates a new CKT7 or raises the existing
%      singleton*.
%
%      H = CKT7 returns the handle to a new CKT7 or the handle to
%      the existing singleton*.
%
%      CKT7('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CKT7.M with the given input arguments.
%
%      CKT7('Property','Value',...) creates a new CKT7 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ckt7_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ckt7_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ckt7

% Last Modified by GUIDE v2.5 05-Sep-2019 04:35:59

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ckt7_OpeningFcn, ...
                   'gui_OutputFcn',  @ckt7_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ckt7 is made visible.
function ckt7_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ckt7 (see VARARGIN)

% Choose default command line output for ckt7
...
[y fs]=audioread('you selected number 7.wav');
sound(y,fs)


% UIWAIT makes ckt7 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ckt7_OutputFcn(hObject, eventdata, handles) 
...
box1= [   r1+r3+r4  -r3       -r4           0         ;...
          -r3       r3+r5+r2  0            -r5        ;...
          -r4       0         r4+r7+r6     -r6        ;...
          0        -r5       -r6           r6+r8+r5  ];
box2= [   v4-v3-v1 ;  v5+v3-v2    ;  v7-v6-v4    ;  v8+v6-v5 ];


global box3_7

if i==0
    box3_7 = inv(box1)*box2
else
    if i3~=0
        if i4~=0
            [box1,box2] = supermesh(1,2,-i3,box1,box2);
        elseif i5~=0
            [box1,box2] = supermesh(2,1,i3,box1,box2);
        else
            [box1,box2] = supermesh(1,2,-i3,box1,box2);
        end
    end
    ...
    if i4~=0
        if i6~=0
            [box1,box2] = supermesh(3,1,-i4,box1,box2);
        else
            [box1,box2] = supermesh(1,3,i4,box1,box2);
        end
    end
    if i5~=0
        if i6~=0
            [box1,box2] = supermesh(4,2,-i5,box1,box2);
        else
            [box1,box2] = supermesh(2,4,i5,box1,box2);
        end
    end
    if i6~=0
        [box1,box2] = supermesh(3,4,-i6,box1,box2);
    end
    ...
    if i2~=0
        [box1,box2] = notsupermesh(2,-i2,box1,box2);
    end
    if i7~=0
        [box1,box2] = notsupermesh(3,i7,box1,box2);
    end    
    if i8~=0
        [box1,box2] = notsupermesh(4,i8,box1,box2);
    end
    box3_7 = inv(box1)*box2
end
