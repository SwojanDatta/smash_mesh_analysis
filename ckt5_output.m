function varargout = ckt5_output(varargin)
% CKT5_OUTPUT MATLAB code for ckt5_output.fig
%      CKT5_OUTPUT, by itself, creates a new CKT5_OUTPUT or raises the existing
%      singleton*.
%
%      H = CKT5_OUTPUT returns the handle to a new CKT5_OUTPUT or the handle to
%      the existing singleton*.
%
%      CKT5_OUTPUT('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CKT5_OUTPUT.M with the given input arguments.
%
%      CKT5_OUTPUT('Property','Value',...) creates a new CKT5_OUTPUT or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ckt5_output_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ckt5_output_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ckt5_output

% Last Modified by GUIDE v2.5 15-Sep-2019 00:20:27

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ckt5_output_OpeningFcn, ...
                   'gui_OutputFcn',  @ckt5_output_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ckt5_output is made visible.
function ckt5_output_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ckt5_output (see VARARGIN)

% Choose default command line output for ckt5_output
...
% UIWAIT makes ckt5_output wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ckt5_output_OutputFcn(hObject, eventdata, handles) 
