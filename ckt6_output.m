function varargout = ckt6_output(varargin)
% CKT6_OUTPUT MATLAB code for ckt6_output.fig
%      CKT6_OUTPUT, by itself, creates a new CKT6_OUTPUT or raises the existing
%      singleton*.
%
%      H = CKT6_OUTPUT returns the handle to a new CKT6_OUTPUT or the handle to
%      the existing singleton*.
%
%      CKT6_OUTPUT('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CKT6_OUTPUT.M with the given input arguments.
%
%      CKT6_OUTPUT('Property','Value',...) creates a new CKT6_OUTPUT or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ckt6_output_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ckt6_output_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ckt6_output

% Last Modified by GUIDE v2.5 15-Sep-2019 00:16:43

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ckt6_output_OpeningFcn, ...
                   'gui_OutputFcn',  @ckt6_output_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ckt6_output is made visible.
function ckt6_output_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ckt6_output (see VARARGIN)

% Choose default command line output for ckt6_output
...
% UIWAIT makes ckt6_output wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ckt6_output_OutputFcn(hObject, eventdata, handles) 
