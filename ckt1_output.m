function varargout = ckt1_output(varargin)
% CKT1_OUTPUT MATLAB code for ckt1_output.fig
%      CKT1_OUTPUT, by itself, creates a new CKT1_OUTPUT or raises the existing
%      singleton*.
%
%      H = CKT1_OUTPUT returns the handle to a new CKT1_OUTPUT or the handle to
%      the existing singleton*.
%
%      CKT1_OUTPUT('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CKT1_OUTPUT.M with the given input arguments.
%
%      CKT1_OUTPUT('Property','Value',...) creates a new CKT1_OUTPUT or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ckt1_output_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ckt1_output_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ckt1_output

% Last Modified by GUIDE v2.5 15-Sep-2019 00:51:00

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ckt1_output_OpeningFcn, ...
                   'gui_OutputFcn',  @ckt1_output_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ckt1_output is made visible.
function ckt1_output_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ckt1_output (see VARARGIN)

% Choose default command line output for ckt1_output
...
% UIWAIT makes ckt1_output wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ckt1_output_OutputFcn(hObject, eventdata, handles) 
