function varargout = ckt6(varargin)
% CKT6 MATLAB code for ckt6.fig
%      CKT6, by itself, creates a new CKT6 or raises the existing
%      singleton*.
%
%      H = CKT6 returns the handle to a new CKT6 or the handle to
%      the existing singleton*.
%
%      CKT6('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CKT6.M with the given input arguments.
%
%      CKT6('Property','Value',...) creates a new CKT6 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ckt6_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ckt6_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ckt6

% Last Modified by GUIDE v2.5 05-Sep-2019 04:02:35

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ckt6_OpeningFcn, ...
                   'gui_OutputFcn',  @ckt6_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ckt6 is made visible.
function ckt6_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ckt6 (see VARARGIN)

% Choose default command line output for ckt6
...
[y fs]=audioread('you selected number 6.wav');
sound(y,fs)


% UIWAIT makes ckt6 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ckt6_OutputFcn(hObject, eventdata, handles) 
