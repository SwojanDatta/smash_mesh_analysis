function varargout = ckt3(varargin)
% CKT3 MATLAB code for ckt3.fig
%      CKT3, by itself, creates a new CKT3 or raises the existing
%      singleton*.
%
%      H = CKT3 returns the handle to a new CKT3 or the handle to
%      the existing singleton*.
%
%      CKT3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CKT3.M with the given input arguments.
%
%      CKT3('Property','Value',...) creates a new CKT3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ckt3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ckt3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ckt3

% Last Modified by GUIDE v2.5 15-Sep-2019 13:20:32

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ckt3_OpeningFcn, ...
                   'gui_OutputFcn',  @ckt3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ckt3 is made visible.
function ckt3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ckt3 (see VARARGIN)

% Choose default command line output for ckt3
...
[y fs]=audioread('you-selected 3.wav');
sound(y,fs)

% UIWAIT makes ckt3 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ckt3_OutputFcn(hObject, eventdata, handles) 
